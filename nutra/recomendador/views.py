...
from .controller import crear_usuario,extraccion_atributos_en_objeto,buscar_contenido_por_texto,recomendar_contenido_home,crear_contenido,crear_consumo,recomendar_contenido_video
...
def view_crear_usuario(request):
    retornos = crear_usuario( extraccion_atributos_en_objeto(request.POST) )
    return HttpResponse (
